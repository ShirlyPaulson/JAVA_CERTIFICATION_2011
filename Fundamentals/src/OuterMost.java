...
public class OuterMost {
    ...
    private String InnerString = "InnerString --- Attribute of OuterMost class";

    // public inner class member
    public class PublicInner {
        private String InnerString = "InnerString------Attribute of Public inner class";
        private String OuterString = "OuterString------Attribute of Public inner class";
