/*
Correct Answer. Line 6 fails to compile because tax is a float and you cannot have
a float variable in a switch statement.
If you change Line 5 to this statement
var tax = (int) (price * tax_rate); // Line 5
 */
