...
public class StreamCollect {
    public static void main(String[] args) {
        ...
        //using stream to add 'place' to all elements, creating another list

        List<String> modifiedList =
                originalList.stream().map(s -> s + "Place")
        ...
        String joinedExample = modifiedList.stream()
        ...
        // Join Strings delimited by a comma
        String joinedExample2 = originalList.stream()
                .collect(Collectors.joining(", "));

        // Join Strings delimited by a comma, prefixed/suffixed with
