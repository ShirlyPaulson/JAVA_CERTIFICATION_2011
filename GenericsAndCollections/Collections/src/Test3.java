...
// outputting [10, 10.0, 10]. If you had typed both with <Integer>,
// the code would have had compiler errors on Line 2 and Line 3,
// since you cannot add a primitive long (autoboxed to Long) or a primitive double
// (autoboxed to Double) to an ArrayList<Integer>.
public class Test3 {
    public static void main(String[] args) {
        //List<Number> list = new ArrayList<Integer>();  // Line 1
        List<Integer> list = new ArrayList<Integer>();  // Line 1
       // list.add(10L); // Line 2
